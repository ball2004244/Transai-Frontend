...
export function QrCodeUI({
    ...
    return (
        <div className="qr-container absolute top-0 left-0 z-10 flex flex-col items-center justify-center w-screen h-screen bg-gray-800 p-2 m-0">
            <div className="qr-container-col flex flex-col items-center justify-center z-20 w-full sm:w-2/3 md:w-1/2 lg:w-1/4 bg-white rounded-lg p-4 m-2">
                <h1 className="qr-title text-4xl text-center font-bold text-gray-800 mt-4 p-2">
                    Scan to Join
                </h1>
                <div className="qr-code flex flex-col items-center justify-center w-full h-full px-5 py-8">
                ...
                <button
                    className="close-btn p-2 m-2 text-gray-700 text-2xl font-bold w-fit select-none"
                    onClick={onClose}
                >
                    Go Back
                </button>
